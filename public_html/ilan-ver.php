 ...
 * Karakter Seti ve Dinamik Yol Onarımlı Versiyon
 */
...
/**
 * 🌳 SONSUZ HİYERARŞİ FONKSİYONU
 */
function ilanKategoriSecenekleri($db, $ust_id = 0, $derinlik = 0) {
    ...
    foreach($kategoriler as $kat) {
        ...
        echo '<option value="'.$kat['id'].'" style="'.$stil.'">'.$girinti.$simge.$kat['adi'].'</option>';
        ilanKategoriSecenekleri($db, $kat['id'], $derinlik + 1);
    }
}
?>
            ...
            <div class="p-section">
                ...
                <div class="form-row">
                    ...
                    <div>
                        ...
                        <input type="number" name="fiyat" required placeholder="0.00" class="p-input" style="font-weight: 900; color: var(--main-g);">
                    </div>
                </div>
            </div>
                ...
                <div class="form-row">
                    <div>
                        ...
                        <select name="iletisim_tercihi" class="p-input">
                            <option value="arama_ve_mesaj">Arama ve Uygulama İçi Mesaj</option>
