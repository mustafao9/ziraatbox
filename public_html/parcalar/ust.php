<?php 
/**
 * ZiraatBox - Kurumsal Header
 * Dosya Yolu: /home/ziraatbo/public_html/parcalar/ust.php
 */
...
if(isset($_SESSION['uye_id'])){
    ...
    // 🚀 ADMİN İÇİN ŞİKAYET BİLDİRİMİ (Yer Sağlayıcı Refleksi)
...
<head>
    ...
    <title><?php echo SITE_ADI; ?> - Tarım Pazaryeri</title>
    ...
    <style>
        ...
        body { font-family: 'Nunito', sans-serif; margin: 0; background: #f4f7f6; }
        ...
        @media screen and (max-width: 768px) {
            .konteynir { flex-direction: column; gap: 15px; padding: 10px; }
            nav { width: 100%; justify-content: center; gap: 10px; flex-wrap: wrap; }
            .nav-link { font-size: 13px; }
            .btn-ilan-ver { width: 90%; text-align: center; font-size: 14px; }
        }
    </style>
</head>
<body>
    ...
    <div class="konteynir">
        ...
        <nav>
            ...
            <?php if(isset($_SESSION['uye_id'])): ?>
                ...
                <a href="cik-yap.php" style="color: #ff8a80; font-size: 12px; font-weight: 900; text-decoration: none; margin-left: 5px;">ÇIKIŞ</a>
            <?php else: ?>
...
<main class="konteynir" style="padding: 20px 0;">